...
**Стэк**:  
- Python - Base (Pandas, Numpy, Pulp, Cvxpy, Math) - ML (SciKit-Learn, Catboost) - DL (TensorFlow, RL(GYM)) - Visualisation (Matplotlib, Seaborn) - Parsing(Bs4) - GEO (Shapely) - Other (pickle, os, shutil, zipfile)
- SQL, Linux, Git  
